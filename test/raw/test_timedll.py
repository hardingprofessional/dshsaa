...
class TestTimeDLL(unittest.TestCase):
	...
	def test_DTGToUTC(self):
		...
		self.assertIsInstance(utc_dtg20, float)
		self.assertIsInstance(utc_dtg19, float)
		self.assertIsInstance(utc_dtg17, float)
		self.assertIsInstance(utc_dtg15, float)
	...
	## UTCToET
	def test_UTCToET(self):
		ds50UTC = 18751.12792065972
		ds50ET = timedll.UTCToET(ds50UTC)
		self.assertIsInstance(ds50ET, float)
		
	## UTCToTAI
	def test_UTCToTAI(self):
		ds50UTC = 18751.12792065972
		ds50ET = timedll.UTCToTAI(ds50UTC)
		self.assertIsInstance(ds50ET, float)
		
	## UTCToTConRec
	def test_UTCToTConRec(self):
		ds50UTC = 18751.12792065972
		(taiMinusUTC, ut1MinusUTC, ut1Rate, polarX, polarY) = timedll.UTCToTConRec(ds50UTC)
		self.assertIsInstance(taiMinusUTC, float)
		self.assertIsInstance(ut1MinusUTC, float)
		self.assertIsInstance(ut1Rate, float)
		self.assertIsInstance(polarX, float)
		self.assertIsInstance(polarY, float)
